...
export default function services() {
  ...
  return (
    <div className='mt-20 w-full px-[20%] flex flex-col justify-center items-center'>
      <h1 className='text-[1.0875em] lg:text-[1.6875em]  mx-auto lg:w-1/3 text-center whitespace-nowrap mt-12 font-Common tracking-[0.32em] text-[#231f20] font-semibold'>PROJE<span className='text-[#991900]'>LERİMİZ</span></h1>
      <div className='mt-8 flex flex-col lg:flex-row justify-center items-center w-full'>
        {items.map(item => {
          return <div className='font-Common lg:px-8 flex flex-col justify-center items-center text-center align-top w-full'>
            ...
            <h2 className='mt-4 tracking-[0.2em] text-[1.125em] leading-[1.35] font-bold text-[#231f20]'>{item.title}</h2>
